<?php
define('API_KEY',"##TOKEN##"); //<====== بجای کلمه توکن توکن ربات خود را قرار دهید
$Dev = 208549102; // <==== آیدی عددی مدیر ربات
$userbot = "addtochatbot"; //<=== نام کاربری ربات
$userchanel = "FoxTeam01"; //<==== آی دی کاتال
